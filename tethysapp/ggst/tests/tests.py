    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.ggst"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.ggst.tests.tests"

        To run tests in the GgstTestCase class:
...
class GgstTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Ggst)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Ggst)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/ggst/')  # The final '/' is essential for all pages/controllers
